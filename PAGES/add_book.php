...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        $stmt->bind_param("sssid", $title, $author, $genre, $publication_year, $price);
        $stmt->execute();
        $stmt->close();
        header("Location: booklist.php?msg=Book%20added%20successfully.");
        exit;
    }
    $book = compact('title', 'author', 'genre', 'publication_year', 'price');
}
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="page-wrapper">
    ...
    <div class="page-header">
        ...
        <p class="page-subtitle">Fill in the details to add a book to the collection.</p>
    </div>
